...
try {
  ...
  $mail->Username   = 'djalekberov@gmail.com'; // Логин на почте
  $mail->Password   = 'RemRemy2003Google'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('djalekberov@gmail.com', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('av.203@mail.ru');
